            ...
            <div class="col">
                ...
                <div class="card bg-light mt-5">
                    <div class="card-body">
                        ...
                        <form action="<?= generateLink('tasks/edit/' . $data['id']) ?>" method="post">
                            ...
                            <div class="form-check">
                                <input type="hidden"
                                       class="form-check-input <?= (!empty($data['status_error'])) ? 'is-invalid' : ''; ?>"
                                       name="status" value="0">
                                <input type="checkbox"
                                       class="form-check-input <?= (!empty($data['status_error'])) ? 'is-invalid' : ''; ?>"
                                       id="status" name="status"
                                       value="1" <?php echo ($data['status'] == 1) ? 'checked' : '' ?>>
                                <label class="form-check-label" for="status">Выполнено</label>
                                <div class="invalid-feedback">
                                    <?= (!empty($data['status_error'])) ? $data['status_error'] : ''; ?>
                                </div>
                            </div>
